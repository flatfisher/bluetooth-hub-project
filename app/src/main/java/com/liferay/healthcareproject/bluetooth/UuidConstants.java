...
public class UuidConstants {
    ...
    public static final String ACC_ENABLE =  "0000aa12-0000-1000-8000-00805f9b34fb";

    public static final String SITU_SERVICE = "6e400001-b5a3-f393-e0a9-e50e24dcca9e";
    public static final String SITU_WEIGHT = "6e400003-b5a3-f393-e0a9-e50e24dcca9e";
